...
def open_file():
    ...
    try:
        window.title(os.path.basename(file1))
        text_area.delete(1.0, END)

        file1 = open(file1, 'r')

        text_area.insert(1.0, file1.read())

    except Exception:
        print('could read file')
    finally:
        file1.close()


def save_file():
    file1 = filedialog.asksaveasfilename(initialfile='untitled.txt',
    ...
    if file1 is None:
        ...
        try:
            ...
            file1.write(text_area.get(1.0, END))
